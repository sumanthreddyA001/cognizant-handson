...
public class SpringLearnApplication {
	...
	public void displayDate() {
		...
		try {
			Date date = fmt.parse("03/07/2021s");
	...
	public static void main(String[] args) {
		...
		LOGGER.info("calling display date method");
		spa.displayDate();
		LOGGER.info("calling display country method");
		spa.displayCountry();
		LOGGER.info("calling display countries method");
